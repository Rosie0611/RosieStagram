...
public class MyBaseAdapter_Comment_FireBase extends BaseAdapter {
    Main6Activity_Comment_Listview_FireBase context;
    int iLayoutResId;
    ArrayList<MyData_Comment> arrData = new ArrayList<>();

    public MyBaseAdapter_Comment_FireBase(Main6Activity_Comment_Listview_FireBase context, int iLayoutResId, ArrayList<MyData_Comment> arrData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        MyData_Comment data_comment = arrData.get(position);
